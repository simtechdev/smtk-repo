...
%description
This is python server implementation of the Socket.IO realtime transport library on top
of the Tornado framework. TornadIO2 is compatible with 0.7+ version of the Socket.IO and
implements most of the features found in original Socket.IO server software.
